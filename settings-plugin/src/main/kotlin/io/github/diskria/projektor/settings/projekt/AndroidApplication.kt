...
data class AndroidApplication(private val projekt: IProjekt, private val settings: Settings) : IProjekt by projekt {

    override val configureRepositories: Settings.() -> Unit = applyRepositories

    companion object {
        val applyRepositories: Settings.() -> Unit = AndroidLibrary.applyRepositories
    }
}
